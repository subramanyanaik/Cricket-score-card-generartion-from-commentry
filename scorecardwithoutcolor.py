...
print('{}{}{}\tR\tB\t4\t6\tSR'.format('Batsman'.ljust(20),'c'.ljust(20),'b'.ljust(15)))
for player in bname:
    if player in z.keys():
        print('{}{}{}\t{}\t{}\t{}\t{}\t{}'.format(player.ljust(20),z[player][0].ljust(20),z[player][1].ljust(15),
              batting_stat[player][0]
    ,batting_stat[player][1],batting_stat[player][2],batting_stat[player][3],
    batting_stat[player][4]))
    else:
        print('{}{}{}\t{}\t{}\t{}\t{}\t{}'.format(player.ljust(20),'not out'.ljust(20),' '.ljust(15),batting_stat[player][0]
        ,batting_stat[player][1],batting_stat[player][2],batting_stat[player][3],
        batting_stat[player][4]))
